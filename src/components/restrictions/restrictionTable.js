...
export default function RestrictionTable({ data }) {
  // const columns = [
  //   { field: data.id, headerName: 'ID' },
  //   { field: data.name, headerName: 'Restriciton Name' },
  //   { field: data.table_target_id.split(':')[0], headerName: 'Table Target' },
  //   { field: data.table_target_id.split(':')[1] + data.table_target_id.split(':')[2], headerName: 'Table Target ID' }
  // ];
